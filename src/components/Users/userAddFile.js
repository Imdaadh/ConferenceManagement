...
const UserAddFile = (props) => {
  ...
  const handleOnSubmit = async (event) => {
    ...
    try {
      const { title, description ,contactDetails} = state;
      if (title.trim() !== '' && description.trim() !== '') {
        if (file) {
          ...
          formData.append('contactDetails', email);
